...
jQuery(function() {
	...
	jQuery(".hb .fa-facebook,.hb .fa-facebook-square").parent().addClass("hb-facebook"), 
    jQuery(".hb.inv .fa-facebook,.hb.inv .fa-facebook-square").parent().addClass("hb-facebook-inv").removeClass("hb-facebook")
	jQuery(".hb .fa-whatsapp,.hb .fa-whatsapp-square").parent().addClass("hb-whatsapp"), 
    jQuery(".hb.inv .fa-whatsapp,.hb.inv .fa-whatsapp-square").parent().addClass("hb-whatsapp-inv").removeClass("hb-whatsapp")
	jQuery(".hb .fa-instagram,.hb .fa-instagram-square").parent().addClass("hb-instagram"), 
    jQuery(".hb.inv .fa-instagram,.hb.inv .fa-instagram-square").parent().addClass("hb-instagram-inv").removeClass("hb-instagram")
